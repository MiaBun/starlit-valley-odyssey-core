...
public class SVORecipeSeralizers {
    ...
    public static final RegistryObject<SackUpgradeRecipeSerializer<SackToToolbeltRecipe>> SACK_TO_TOOLBELT = RECIPE_SERIALIZERS.register("sack_to_toolbelt", () -> new SackUpgradeRecipeSerializer<>(SackToToolbeltRecipe::new));

    public static final RegistryObject<RecipeSerializer<KeepContentsSmithingRecipe>> SMITHING_KEEP_CONTENTS =
            RECIPE_SERIALIZERS.register("smithing_keep_contents", KeepContentsSmithingRecipe.Serializer::new);
}
