...
public class SVOSmithingTemplate extends Item {

    private final String tier;

    public SVOSmithingTemplate(String tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal(" ")
                .append(Component.translatable("item.svo." + tier + "_upgrade_smithing_template.applies_to")
        ...
        tooltip.add(Component.literal(" ")
                .append(Component.translatable("item.svo." + tier + "_upgrade_smithing_template.ingredients")
                        .withStyle(ChatFormatting.BLUE)));
    }
}
