...
public enum SVOArmorMaterials implements ArmorMaterial {
    ...
    @Override public int getDurabilityForType(ArmorItem.Type type) { return HEALTH_PER_SLOT[type.ordinal()] * durabilityMultiplier; }
    ...
    @Override public String getName() { return SVOCore.MOD_ID + ":" + name; }
