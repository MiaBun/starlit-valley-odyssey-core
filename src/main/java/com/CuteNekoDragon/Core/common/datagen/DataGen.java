...
public class DataGen {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.jamborite",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.malachite",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.lemon_stone",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.orpiment",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.thunder_egg",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.ocean_stone",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.jasper",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.soapstone",
                "Because of its relatively soft consistency, this stone is very popular for carving.");
        REGISTRATE.addRawLang("tooltip.svo_core.hermatite",
        ...
        REGISTRATE.addRawLang("tooltip.svo_core.slate",
                "It's extremely resistant to water, making it a good roofing material.");
        REGISTRATE.addRawLang("tooltip.svo_core.fairy_stone",
