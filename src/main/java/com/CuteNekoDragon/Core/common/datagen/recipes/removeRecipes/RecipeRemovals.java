...
public class RecipeRemovals {
    ...
    public static void register() {
        ...
        RecipeBlacklist.blacklistId(
                "sophisticatedstorage:backpack_stack_upgrade_starter_tier_from_storage_stack_upgrade_tier_1_plus");
        RecipeBlacklist
                .blacklistId("sophisticatedstorage:backpack_stack_upgrade_tier_1_from_storage_stack_upgrade_tier_2");

        RecipeBlacklist.blacklistId("sophisticatedbackpacks:stack_upgrade_tier_2");
        RecipeBlacklist
                .blacklistId("sophisticatedstorage:backpack_stack_upgrade_tier_2_from_storage_stack_upgrade_tier_3");
        ...
        RecipeBlacklist
                .blacklistId("sophisticatedstorage:backpack_stack_upgrade_tier_3_from_storage_stack_upgrade_tier_4");

        RecipeBlacklist.blacklistId("sophisticatedbackpacks:stack_upgrade_tier_4");
        RecipeBlacklist
                .blacklistId("sophisticatedstorage:backpack_stack_upgrade_tier_4_from_storage_stack_upgrade_tier_5");

        RecipeBlacklist.blacklistId("sophisticatedstorage:stack_upgrade_tier_1");

        RecipeBlacklist
                .blacklistId("sophisticatedstorage:storage_stack_upgrade_tier_2_from_backpack_stack_upgrade_tier_1");
        ...
        RecipeBlacklist
                .blacklistId("sophisticatedstorage:storage_stack_upgrade_tier_3_from_backpack_stack_upgrade_tier_2");
        RecipeBlacklist.blacklistId("sophisticatedstorage:stack_upgrade_tier_3");

        RecipeBlacklist
                .blacklistId("sophisticatedstorage:storage_stack_upgrade_tier_4_from_backpack_stack_upgrade_tier_3");
        RecipeBlacklist.blacklistId("sophisticatedstorage:stack_upgrade_tier_4");

        RecipeBlacklist
                .blacklistId("sophisticatedstorage:storage_stack_upgrade_tier_5_from_backpack_stack_upgrade_tier_4");
