...
public final class MailService {
    ...
    public static boolean sendLetter(ServerPlayer player, ResourceLocation letterTemplateId, ResourceLocation npcId,
                                     Component npcDisplayname) {
        return sendLetter(player, letterTemplateId, npcId, npcDisplayname, Map.of());
    }

    public static boolean sendLetter(ServerPlayer player, ResourceLocation letterTemplateId, ResourceLocation npcId,
                                     Component npcDisplayname, Map<String, String> extraPlaceholders) {
